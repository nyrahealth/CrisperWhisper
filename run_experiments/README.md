...
```
When your Dataset(s) are stored in the correct format you should be able to easily run the Experiments as defined in the Segmentation_experiments.ipynb

In the notebook make sure to adjust your 
...
The structure for a labels.json file looks like this and includes timing information and relative path:
...
In the `Segmentation_experiments.ipynb` notebook make sure to adjust your Experiment configuration accordingly and run your own experiments.
