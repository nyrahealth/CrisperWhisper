...
@st.cache_resource
def load_model_and_processor(model_id: str) -> Tuple[AutoModelForSpeechSeq2Seq, AutoProcessor]:
...
def timestamps_to_vtt(timestamps: List[Dict[str, Union[str, Tuple[float, float]]]]) -> str:
